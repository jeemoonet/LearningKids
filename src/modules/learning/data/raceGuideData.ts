...
export const RACE_GUIDES: RaceGuideEntry[] = [
  ...
  },
  {
    ...
    synergy: '面对 学者 ADJ 妖怪时同词性 -20%；需 学者 ADJ 出手相生 +20%。',
    relations: '与 学者 ADJ 相伴：形容词修饰名词（happy day）。平民编队是占领王国的基本兵力。',
  },
  {
    pos: 'adjective',
    grammar: '修饰名词，描述性质与状态。',
    power: '裸战力 = 音节 × 1.0；专克名词类敌人。',
    synergy: '打 平民 NOUN 妖怪相生 +20%；打 学者 ADJ 妖怪时，魔法师 ADV 相生 +20%。',
  ...
  },
  {
    ...
    synergy: '打 武士 VERB 妖怪相生 +20%；打 学者 ADJ 妖怪同样相生 +20%。',
    relations: '与 武士 VERB、学者 ADJ 形成修饰链：副词→动词、副词→形容词，是语法搭配的核心纽带。',
  },
  {
    pos: 'prep',
